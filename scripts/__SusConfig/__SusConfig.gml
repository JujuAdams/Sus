...
{
    switch_controller_set_supported_styles(switch_controller_handheld | switch_controller_joycon_dual | switch_controller_pro_controller);
    ...
    switch_controller_set_default_joycon_assignment(switch_controller_joycon_assignment_dual);
